...
input_dir = "./datasets/train/ILSVRC2012_img_val"
save_dir = "/home/hyq/datasets/Imagenet_val"
...
Parallel(n_jobs=20,backend='multiprocessing')(delayed(pipline)(idx, img_path) for idx, img_path in enumerate(filtered))
